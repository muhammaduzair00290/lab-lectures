...
if (name.Length < 8 || name.Length > 16)
{
    ...
    Console.WriteLine($" enter a  name   again in between 8 to 16 characters  ");
...
{
    Console.WriteLine(" konsi dunya sy aye ho ");
}
...
if (password.Length < 8 || password.Length > 16)
{
    ...
    {
        Console.WriteLine(" password is correct lets compare ");
    }
...
{
    Console.WriteLine(" chal o nikal ");
}
